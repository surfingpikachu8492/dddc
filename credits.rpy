...
label credits:
    ...
    pause 0.5
    $ consolehistory = []
    call updateconsole ("renpy.music.play(\"dddc.ogg\")", "Playing audio \"dddc.ogg\"...") from _call_updateconsole
    pause 1.0
...
label credits2:
    ...
    show credits_header "Game Coding & Developer" as credits_header_1 at credits_text_scroll_left
    show credits_text "SilverZone430" as credits_text_1 at credits_text_scroll_left
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Satchely\nMeow~\nSora101Ven" as credits_text_2 at credits_text_scroll_right
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Velinquent\nGoogle\nUmaru(Gintoki)" as credits_text_1 at credits_text_scroll_left
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "JackBurst\nSilverZone430" as credits_text_2 at credits_text_scroll_right
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_header "Concept & Game Design" as credits_header_2 at credits_text_scroll_right
    ...
    show credits_text "Sayori\nNatsuki\nYuri" as credits_text_1 at credits_text_scroll_left
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Monika\nDiscord Friends" as credits_text_2 at credits_text_scroll_right
    ...
    show credits_header "Special Thanks" as credits_header_1 at credits_text_scroll_left
    show credits_text "Google Chrome\nJackBurst" as credits_text_1 at credits_text_scroll_left
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    ...
    show credits_ts
    show credits_text "made with love by Team Salvato and":
