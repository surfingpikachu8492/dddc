...
label ch0_end:
    ...
    "I blink my eyes, my eyelids almost resisting the process."
    "I spend the next minute staring at a wall, trying to understand what's happening."
    ...
    "Desperately trying to put my thoughts back together, I close my eyes and attempt to shut out the noise from outside..."
    ...
    "Along with my memories, my logic and thought processes start showing some signs of life as well, shortly after."
    "..."
    "It's late at night."
    ...
    "W-Wait, no! Midterms have ended just yesterday!"
