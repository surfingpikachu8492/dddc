...
label poemresponse_3_sayori:
    ...
    s "And what do you think? Did you manage to make some progress?"

    mc "I was hoping you would tell me."
    ...
    "Sayori has never been good with idioms..."
    ...
    "To be fair, I hardly have a preference, but..."
    ...
    mc "I would even go as far as to say that I'm amazed..."
    ...
    mc "..."
    mc "W-Wait, Sayori, but you never walked to park on your own. When did that--"
    ...
    "I might have been fine, but Sayori probably took it harder than I did."
    "..."
    "Looks like that chat of ours was more than just her feeling nostalgic."
    ...
    "We spend the next few seconds in silence."
    "I'm still trying my best to calm down the small hurricane of emotions going through me..."
    "What did she say yesterday?"
    "{i}It's all about your emotions!{/i}"
    "{i}They could describe the beauty of our everyday lives and those little things that make us a bit happier!{/i}"
    "Yeah, I guess I should have given Sayori more credit, at least on her skills in poetry."

    mc "Heh... You really impressed me, Sayori. I'll give you that."

    show sayori 1q with dissolve_chr
    s "I'm glad to hear it. I worked really hard on this one, after all."
    ...
    mc "Anyway, we should probably wrap things up now."
...
label poemresponse_3_sayori_appeal_sayori:
    if poemwinner[0] == "sayori":
        ...
        s "And that you aren't letting yourself be influenced by anyone."
        show sayori 1y with dissolve_chr
        s "You have to stick to your style, not try to change it just to impress someone."
        ...
        mc "Sayori, if there's one thing I don't usually know..."
        mc "...then it's what you're talking about."

        show sayori 1l with dissolve_chr
        s "Ehehehe..."
        s "Okay, okay. You have a point there..."
        show sayori 3y with dissolve_chr
        s "What I'm trying to say is that people might say that your style is too simple..."
        show sayori 1G with dissolve_chr
        s "But I think that it's actually very nice."
        show sayori 1a with dissolve
        s "You know, sometimes, poems like these are much deeper than any that are filled with... metaphorical stuff and cool words..."
        show sayori 1y with dissolve_chr
    ...
    show sayori 5a with dissolve
    s "I'm not that bad, compared to the others, right?"
    ...
    s "...Natsuki can say in few words what others can only say in a whole novel..."
    s "...and Monika is just perfect overall."
    ...
    mc "Really, Sayori, I thought that I was the one here who's the least confident about their skills..."
    ...
    mc "And yet that doesn't stop you from being the vice president here."
    show sayori 1G with dissolve_chr
    mc "Besides, you were quite confident about your style during the argument yesterday."

    show sayori 3y with dissolve_chr
    s "Yeah... and I really hope I didn't offend anyone..."
    ...
    mc "It might seem simple at first, but it has its own beauty."
    ...
    mc "...but I'm afraid we're still pretty different."
    show sayori 1G with dissolve_chr
    mc "Besides, just like I said yesterday, I still don't really know what I'm doing and if I even have a style to begin with."
    ...
    s "Because you're here now and that's what really matters!"
...
label poemresponse_3_sayori_appeal_natsuki:
    if poemwinner[0] == "natsuki":
        ...
        mc "And now you're doing it again!"
        ...
        s "Ahahahaha!"
        mc "..."
        "It takes at least ten seconds for Sayori to finally calm down. The others are throwing awkward glances in our direction."
        show sayori 1F with dissolve_chr
        s "Hahaha... hah... I'm so--... I'm s-sorry..."
        show sayori 3E with dissolve_chr
        s "You even sound like her!"
        mc "Sayori, laughing in my face won't help me understand what you're on about, you know?"
        ...
        show sayori 1a with dissolve_chr
        s "Hey, I didn't say it's bad! You didn't make much progress, but I guess you're just experimenting a bit..."
        show sayori 1x with dissolve_chr
        s "You know, trying to find your style and all?"
        mc "Maybe..."
        mc "So what's your opinion on it? That new... style I apparently chose."
        show sayori 1q with dissolve_chr
        s "Well... now that you've asked..."
    ...
    $ renpy.say(s, "Or, at least she said she does. I've only seen {n} of her poems so far...".format(n="two" if poemsread > 0 else "one"))

    mc "Wait, you mean... you're talking about someone from our club?"

    show sayori 4r with dissolve_chr
    s "Of course, silly! Where else would you get inspiration for writing a poem like this one?"
    show sayori 1x with dissolve_chr
    s "Just think. Does it ring a bell? Short, simple, and efficient?"

    mc "I guess? Who should it remind me of?"

    show sayori 4x with dissolve_chr
    s "Natsuki, of course! It's obviously her style!"
    show sayori 3l with dissolve_chr
    s "Okay, not exactly her style, but it's pretty similar to hers..."
    ...
    show sayori 1x with dissolve_chr
    s "Hmm... You know, now that I think about it, it might actually be a good thing!"
    ...
    "We both start covering our mouths to muffle our laughter."
    ...
    s "Ahaha... Yeah, before Monika gets mad and tells us to quiet down..."
    show sayori 1y with dissolve_chr
...
label poemresponse_3_sayori_appeal_yuri:
    if poemwinner[0] == "yuri":
        ...
        show sayori 1r with dissolve_chr
        s "Well, yeah, I was talking about your poem..."
        show sayori 1s with dissolve_chr
        s "...but now that you've mentioned it, I still think that you do watch too much anime!"
        mc "Sigh..."
        ...
        s "Ehehehe..."
        show sayori 1a with dissolve_chr
        s "I'm just saying that it's really weird that you've suddenly changed your style."
        ...
        mc "Yeah, sorry about that."
        mc "So, can you tell me what you think about it?"
        mc "I get that it's different, and it makes sense since I tried to remember what you all told me yesterday and actually listen to your feedback."
        ...
        show sayori 1c with dissolve_chr
        s "Its style, its meaning, its language... all of it is so--"
        show sayori 1o with dissolve_chr
        s "..."
        s "Wait a minute..."
        show sayori 1E with dissolve_chr
        ...
        mc "Well, then you've found out something about my poem even I don't know. Congrats."
    ...
    show sayori 4r with dissolve_chr
    $ renpy.say(s, "I'm sure she{v} it!".format(v=" loved" if y_readpoem else "'ll love"))
    show sayori 1l with dissolve_chr
    s "And I bet she could also give you some good advice. She's the one here with most experience, after all..."
    ...
    mc "So all of that might just be a coincidence at this point."

    show sayori 1a with dissolve_chr
    s "Yeah... You might be right."
    s "..."
    s "But still... When you think about it..."
    s "She's so shy... and so cute..."
    mc "Huh?"
    s "N-Never mind! Forget I said anything!"
    mc "Um... Is everything okay?"
    s "Yeah, sure! Don't worry. I just... It doesn't mater."
    mc "If you say so."

    mc "Anyway, can you show me your poem now?"
...
label poemresponse_3_sayori_appeal_monika:
    if poemwinner[0] == "monika":
        ...
        show sayori 1x with dissolve_chr
        s "It's not surprising. You've try to make your poems so serious, so complex, and yet so easy to understand!"
        s "It looks like you're dashing through, trying to be the best at everything!"
        mc "And how am I doing?"
        show sayori 3l with dissolve_chr
        s "Ehhh... Not that well..."
        mc "Figured as much."
        show sayori 1b with dissolve_chr
        ...
        mc "Anyway, can you tell me how it's different?"
        show sayori 1c with dissolve_chr
    ...
    mc "What do you mean, 'her'?"

    show sayori 4r with dissolve_chr
    s "Oh, quit playing dumb. You know I'm talking about Monika!"
    ...
    show sayori 1r with dissolve_chr
    s "Because now you're in this club, silly. You get to see her everyday!"
    show sayori 1x with dissolve_chr
    ...
    mc "..."
    "{i}You have a talent for making things sound awkward, Sayori...{?i}"
...
label poemresponse_3_yuri:
    ...
    y "O-Oh, yes, I suppose I'm really not the one to point out someone's lack of confidence, am I?"
    ...
    y "..."
    y "I... have my reasons..."
    "{i}And there's that defensive attitude again...{/i}"
    ...
    "To be fair, knowing her personality, I could probably call it a private diary of sorts."
    ...
    mc "Yuri, is there ever a time when you're not so self-conscious?"
    show yuri 3n with dissolve_chr
    ...
    mc "It's really beautiful, though. It makes me feel like I can see and experience all the same things as the person in the poem."

    show yuri 3u with dissolve_chr
    y "Yes... I personally think nature is one of most gorgeous things you can possibly convey in any sort of art, especially in prose or poetry..."
    show yuri 2u with dissolve_chr
    ...
    mc "Vaguely..."
    mc "I'll be honest with you, Yuri. I still don't get you, but whatever this world is you live in, I'm sure it's something fascinating."
    show yuri 2u with dissolve_chr
    y "Thank you... It's really nice to hear that coming from you."
    mc "I'm glad you shared it with me."
    mc "Okay, now I've got to go."
    show yuri 1m with dissolve_chr
    y "Yes, you're right. I've already taken enough of your time."
...
label poemresponse_3_yuri_appeal_sayori:
    ...
    mc "Oh, uh... We've been friends since we were kids. I thought Sayori told you that."

    show yuri 1m with dissolve_chr
    y "Then I guess it makes sense."

    mc "What makes sense, Yuri? What do you mean? What does Sayori have to do with my poems?"
    ...
    mc "Well... I guess we have to be somewhat similar... We're good friends, after all..."
    mc "But I still don't see how our poems fall into this."

    show yuri 2k with dissolve_chr
    y "Do you remember what I said on your first day?"
    ...
    show yuri 1m with dissolve_chr
    mc "Wait, Yuri, what did you mean--"
    show yuri 2m with dissolve
    y "I'm sorry, [player], but I would't want to tell you anything I'm not sure of yet."
    ...
    mc "..."
    mc "Sigh..."
    mc "I guess we'll just move on to your poem now?"
...
label poemresponse_3_yuri_appeal_natsuki:
    if poemwinner[0] == "natsuki":
        show yuri 2i at t11
        y "..."
        y "I can't say I understand your choice, but I can at least see that it's not deliberate, more or less..."
        mc "Yuri, you're a master of speaking in riddles, but I'm really not in the mood to solve them right now."
        show yuri 1m with dissolve_chr
        y "Well, you see, at first I assumed that your choice of this particular style was coincidental..."
        show yuri 1a with dissolve_chr
        y "...but I suppose that you indeed chose it because it... suits you."
        mc "To be fair, I think that most of the things I do are just coincidences..."
        show yuri 1i with dissolve_chr
        ...
        show yuri 2f with dissolve_chr
        y "What inspired you to make such a change?"
        mc "Um... I think 'inspired' is a strong word, Yuri."
        mc "And what do you mean by 'change'? Definitely not the quality, I'd wager."
        show yuri 2h with dissolve_chr
        y "It's the style, [player]... It's different from the one you used yesterday..."
    ...
    show yuri 1u with dissolve_chr
    y "Well, there's only one other person I know who shares a similar style..."
...
label poemresponse_3_yuri_appeal_yuri:
    if poemwinner[0] == "yuri":
        ...
        y "..."
        show yuri 2s with dissolve_chr
        y "[player], I see you're making some progress."
        ...
        y "Be it the beauty of nature, or the tale of a lone wanderer... there are so many exquisite words which you can use to describe it all..."
        mc "..."
        show yuri 2B with dissolve_chr
        y "...?"
        show yuri 3q with dissolve_chr
        ...
        show yuri 2s with dissolve_chr
        y "The point is, I'm impressed by your progress. I really think you can go far."
    ...
    mc "Trying to get me to make up my mind, Yuri?"
    show yuri 3q with dissolve_chr
    "Yuri giggles shyly."
    y "I hope you don't blame me too much for that..."

    mc "Not really. It is pretty weird to be a member of the Literature Club with close to no interest in literature, after all."
    show yuri 2u with dissolve_chr
    y "My point exactly."
    ...
    show yuri 1s with dissolve_chr
    y "It would be nice to have someone to talk to about it."
    mc "Yeah, yeah. I hear you. I said I'd think about it."
    mc "Is reading your poem good enough for now?"
    show yuri 3d with dissolve_chr
    y "I suppose it'll have to do."
    return
...
label poemresponse_3_yuri_appeal_monika:
    if poemwinner[0] == "monika":
        ...
        y "Hmm... I see you're not someone looking to do this the easy way..."
        mc "Yuri, for me, pretty much everything it the hard way, you know?"
        mc "Also, what are you actually talking about?"
        show yuri 1m with dissolve_chr
        y "Hmm, when viewing it from that perspective, it might not be a bad thing, after all."
        show yuri 1a with dissolve_chr
        ...
        show yuri 1l with dissolve_chr
        y "Your ultimate goal would be to deliver every aspect of the poem on the highest level."
        show yuri 1i with dissolve_chr
        y "The problem is that not everyone's up to the task."
        mc "And I guess that includes me..."
        show yuri 2j with dissolve_chr
        y "You know, [player], I'm actually more curious about what inspired you to pick this style in the first place..."
        ...
        y "Eh?"
        show yuri 2h with dissolve_chr
        y "O-Oh, I was saying that it's... not what I expected you to draw from my feedback yesterday..."
        ...
        y "And to be honest, I think you might be biting off a bit more than you can chew..."
        mc "Okay, now I'm completely confused. What are you talking about, Yuri?"
        show yuri 1v with dissolve_chr
        y "Well, you see, this style is somewhat close to mine, but it..."
        show yuri 2h with dissolve_chr
        y "...No, no. That's not the point..."
        show yuri 2t with dissolve_chr
        y "I wanted to tell you that this style... It's not usually a good option to start with."
        mc "Um... Why? Is it too complicated or...? You said I'm biting off more than I can chew."
        show yuri 1v with dissolve
        y "Yes, that's exactly what I meant. It's challenging, it's demanding, it sets the bar quite high..."
        show yuri 1t with dissolve_chr
        y "It's possible that you just got a bit overwhelmed with all our opinions yesterday and decided that you need to make everything flawless in order to make up for it..."
        ...
        y "For example, just take a look at--"
    ...
    mc "I... agree with you, Yuri, but I don't quite get what you were saying about the whole 'guidance' thing..."

    show yuri 1m with dissolve_chr
    y "I meant that it seems she's been something of a source for your inspiration."
    show yuri 1i with dissolve_chr
...
label poemresponse_3_natsuki:
    ...
    n "Well, it's better than this morning, I guess."
    mc "Yeah, you don't look as moody as you were earlier. So that's a good thing."
    mc "But it still seems like there's something bugging you."
    n "Yeah, well..."
    n "..."
    n "This whole poem thing..."
    ...
    mc "Come now, Natsuki. First, you were worried about Monika messing with your manga collection..."
    mc "...and now you're worried about the poems. It almost sounds like you're afraid of her or something."
    show natsuki 5e with dissolve_chr
    n "Hey! I never said I was afraid or anything!"
    ...
    mc "You do understand that she's doing this for us?"
    mc "She's helping us with our insecurities, helping us improve our writing skills and strengthening the bond of our club, all at the same time."
    show natsuki 5m with dissolve_chr
    n "Yeah, I know that, but that still doesn't help me..."
    ...
    mc "You know what, Natsuki? It's really nice to see you unwind every now and then."
    ...
    mc "Really now? Then how about you give me your poem and let me learn a thing or two?"
    ...
    mc "I like it. Even more than your last one, actually."
    n "You... mean it?"
    mc "Well, yeah. It feels a lot closer to what you were saying yesterday."

    show natsuki 5q with dissolve_chr
    n "Oh, you're just saying that!"
    show natsuki 5u with dissolve_chr
    n "..."
    n "I wouldn't expect you to understand..."
    mc "And why is that, exactly?"
    show natsuki 5t with dissolve_chr
    n "Well, 'cause you're the type of person that never leaves his house!"

    mc "Hey! Where did that even come from?"
    mc "Besides, I do leave my house... every once in a while."
    ...
    n "Not a problem you'd usually face sitting at home by yourself all day, you know?"
    ...
    n "Didn't you try that earlier?"

    mc "It's a different one this time: Is the fox in this poem actually you?"

    show natsuki 5i with dissolve_chr
    n "..."
    n "Why does it matter?"
    mc "I was just thinking that, if your poem yesterday was about you, then this one might be as well."
    n "Well... yeah. I guess so."
    ...
    mc "But then... Who's the lion in this poem?"
    ...
    n "It doesn't matter!"
    mc "Whoa, s-sorry..."
    "{i}Why am I apologizing, exactly?{/i}"
...
label poemresponse_3_natsuki_appeal_sayori:
    if poemwinner[0] == "sayori":
        ...
        mc "My poem? Please. I don't recall the last time I made any sense..."
        show natsuki 3d with dissolve_chr
        n "Well, I can't say I blame you for writing like this. It's just easier this way."
        ...
        n "But that's okay. After all it takes skill to write something that would leave a reader in awe!"
        "{i}Is this really the same girl that was so hesitant to share her work a moment ago?{/i}"
        show natsuki 5t with dissolve_chr
        ...
        mc "What do you mean?"
        show natsuki 3h with dissolve_chr
        n "Well, you switched to a different style."
        n "This new poem of yours is... way too carefree for my taste."
        show natsuki 4h with dissolve_chr
        n "I suppose you just thought that it's too early for you to write something complex and you decided to play it safe, huh?"
        mc "Um... Aren't you the one who always talks about keeping things simple?"
        show natsuki 4q with dissolve_chr
        n "Well, yeah, but this isn't what I meant."
        n "There's no point in making it too complicated..."
        ...
        mc "I won't lie, you do have a point."
        mc "I was writing it because... well, I needed to write something. That's all."
        show natsuki 3d with dissolve_chr
        n "You know, when you put it like that, I think I understand why you're writing like this..."

    mc "Really? Then tell me what this is all about."
    show natsuki 5z with dissolve_chr
    "Natsuki giggles playfully."
    show natsuki 5t with dissolve_chr
    ...
    show natsuki 3y with dissolve_chr
    n "Well, now that you've said it, I do see you two together every day, you know?"

    mc "..."
    mc "W-Wait, what are you--"
    show natsuki 3d with dissolve_chr
    n "But if we're talking about how you two look, then I hope you know that looks can be deceiving?"
    "{i}You're living proof of that, Natsuki...{/i}"
...
label poemresponse_3_natsuki_appeal_yuri:
    if poemwinner[0] == "yuri":
        ...
        n "Well, I guess I shouldn't have expected anything different..."
        mc "What's wrong?"
        show natsuki 3q with dissolve_chr
        n "Jeez, it's so hard for me to see so many people sticking to this style, it makes me feel like I'm doing something wrong..."
        ...
        mc "I listened to everyone, Natsuki, including you."
        mc "And to be honest, I feel like I'm experiencing déjà vu right now."
        show natsuki 3k with dissolve_chr
        n "What do you mean?"
        mc "Weren't you arguing about which style was better yesterday?"
        show natsuki 3m with dissolve_chr
        n "Huh?"
        show natsuki 3u with dissolve_chr
        n "Oh... that..."
        ...
        mc "Well, I don't recall getting any specifications..."
        show natsuki 4h with dissolve_chr
        n "And I was naive enough to expect you to figure it out on your own!"
        mc "Sigh..."
        mc "Just tell me what's wrong, Natsuki."
        show natsuki 4i with dissolve_chr
        n "You know, I'd kinda hoped that you would pay more attention to what I said."
        ...
        n "Well, yeah. That's exactly what I was telling you when we shared our poems!"
    ...
    n "And besides, that last argument was probably the worst we've had. We even managed to drag the rest of you into it..."
    mc "Well, it's like Monika said: 'There's no such thing as the right way.'"
    show natsuki 5u with dissolve_chr
    n "Yeah, yeah..."
    mc "That said, can you tell me what you think of my poem? Did I make any progress, at least?"
    show natsuki 5t with dissolve_chr
...
label poemresponse_3_natsuki_appeal_natsuki:
    if poemwinner[0] == "natsuki":
        show natsuki 3a at t11
        n "..."
        n "Hmm... guess I underestimated you, [player]."
        ...
        mc "Whoa, is that positive feedback I hear?"
        mc "Who are you and what have you done with my Natsuki?"
        show natsuki 5g with dissolve_chr
        n "{i}(D-Don't call me yours...){/i}"
        show natsuki 5h with dissolve_chr
        n "What I was trying to say is that I'm... glad that you listened to me..."
    ...
    show natsuki 5h with dissolve_chr
    n "H-Hey, I never said I liked it..."
    show natsuki 5s with dissolve_chr
    n "I mean, like... 'like' like..."
    "I cover my mouth, trying to supress the laughter."
    mc "What was that? I think you just said 'like' three times in a row."
    show natsuki 5w with dissolve_chr
    n "N-Never mind!"
    mc "Also, you actually did say you liked it. And it makes sense to me. I mean, our styles kinda similar and all."
    show natsuki 5e with dissolve_chr
    n "Yeah, 'similar,' but that's the best I can say about it so far!"
    show natsuki 5w with dissolve_chr
    ...
    n "Grrr..."
    n "I'm saying that it's... nice to see that you're at least making progress..."
    show natsuki 4e with dissolve_chr
    n "But... don't expect me to actually care about it, you hear?"
    show natsuki 3r with dissolve_chr
    n "And..."
    show natsuki 3o with dissolve_chr
    n "...?!"
    show natsuki 4p with dissolve_chr
    n "H-Hey, get that smile off your face! What's so funny?!"
    mc "It's nothing, Natsuki. I guess I'm just in a good mood."

    show natsuki 5x with dissolve_chr
    n "Hmph! Sure you are..."
    mc "Okay, do I get to see your poem now?"
...
label poemresponse_3_natsuki_appeal_monika:
    if poemwinner[0] == "monika":
        show natsuki 3k at t11
        n "..."
        n "I'm still surprised by your choice, [player]..."
        mc "Stick around. I'm full of surprises..."
        show natsuki 5h with dissolve_chr
        n "Heh... We'll see if they're any good."
        mc "Who knows? Anyway, could you tell me what surprised you so much?"
        show natsuki 5q with dissolve_chr
        ...
        show natsuki 5w with dissolve_chr
        n "But, now that I think about it, you might just be stubborn and not care much about our opinions!"
        mc "Natsuki, you're doing it again."
        show natsuki 5b with dissolve_chr
        n "Doing what?"
        mc "Jumping to conclusions. What makes you think that I don't care about your opinion?"
        mc "At this point, it's stupid for me to ignore what you all have to say, right?"
        show natsuki 4e with dissolve_chr
        n "Then why are you trying to be so bold? Who are you trying to impress?"
        n "I told you before that it's a tough way to start! And yet you're still getting ahead of yourself!"
        n "What will you prove to anyone with--"
        show natsuki 3t with dissolve_chr
        n "..."
        n "Waaait a second..."
        mc "Hmm?"
        ...
        mc "There's no point in trying without setting any goals for yourself..."
        show natsuki 3d with dissolve_chr
        n "Ahhh, I see..."
        n "Now I recognize that attitude!"
    ...
    mc "Sigh..."
    mc "Natsuki, it's just a poem... How do you even come up with these conclusions?"
    show natsuki 3d with dissolve_chr
    n "Meh, I don't know. Let's just say I've got a feeling."
    show natsuki 3t with dissolve_chr
    n "But I suppose it might just be a coincidence..."
    mc "I suggest we leave it as that and move on to your poem."
    show natsuki 3d with dissolve_chr
...
label poemresponse_3_monika:
    ...
    m "You seem more confident than yesterday. That's a good sign."
    m "Do you think you managed to make some progress?"
    mc "Well, I certainly hope so... I made my first step. Probably wasn't a big one after just one day..."
    ...
    m "That's one of the reasons I came up with the whole idea in the first place!"
    m "By listening to what others have to saym you might find weak spots in your works or discover some inspiration for new ones!"
    ...
    show monika 2k with dissolve_chr
    m "At ease, soldier. I don't want this club to turn into a battlezone..."
    mc "If you want, I can go and call Natsuki 'cute' to turn it into a crime scene."
    show monika 2l with dissolve_chr
    m "Ahahaha! Please don't do that. We'd never see the end of it."
    show monika 1m with dissolve_chr
    m "Anyway, let me see your poem now."
    mc "Hey! Why am I first again?"
    show monika 3k with dissolve_chr
    m "Chain of command!"
    mc "...Right."
    show monika 1j with dissolve_chr
    "Monika giggles as I hand her my poem."
    ...
    show monika 2j with dissolve_chr
    m "So?"
    mc "An interesting coincidence, don't you think?"
    mc "The same day you tell me about your interest in music..."
    mc "...your poem just so happens to be about music."
    "Monika giggles playfully."
    m "You're so persistent, [player]."
    m "Like I said, I really am flattered, but we should focus on the task at hand. We don't have too much time left for today."
    mc "If you say so."
    mc "Anyway..."
    ...
    mc "What's with all those... spaces?"

    show monika 4b with dissolve_chr
    m "This style got somewhat popular recently. I decided to experiment a bit."
    ...
    m "Surprisingly enough, I would say it works for me."

    mc "Well, it's definitely different from your previous poem..."
    mc "Can you give me some sort of clue? I'm honestly lost here."
    if y_readpoem:
        mc "And I even kind of understood Yuri's poem today, so that's saying something."
    else:
        mc "Even Yuri's poem yesterday wasn't this complicated..."

    show monika 2k with dissolve_chr
    m "Ahahaha! Yes, Yuri has a habit of keeping what she had in mind a mystery."
    show monika 3b with dissolve_chr
    m "That's why I really appreciate Natsuki's poems. With all their simplicity, they give you such a clear picture!"
    ...
    m "That's why I want you all to appreciate your uniqueness! You all excel at something, so what's the point of finding out who's better?"

    mc "Says the girl who's pretty much the best at everything..."

    show monika 1l at s11
    m "I-I think you're exaggerating, [player]..."

    mc "Am I? Maybe a little bit, but look at yourself, Monika."
    mc "You seem to be doing pretty well for yourself."

    show monika 3n with dissolve_chr
    m "I understand where you're coming from, but you should understand that I'm not trying to be best at everything..."
    ...
    m "Though I won't lie, you're not the first one who said something like that to me..."

    mc "Oh, uh... I didn't mean to offend you in any way..."
    ...
    show monika 2a with dissolve
    m "That is why I started playing with the space I had here, and that's why this poem turned out so freeform and so different from my usual, methodical approach to things."
    show monika 2j with dissolve_chr
    ...
    show monika 4b with dissolve_chr
    m "But the most important lesson which I want you to learn from it is that you, first of all, have to actually try."
    m "{i}Transpose it up or down, but that experience never falls flat.{/i}"
    show monika 2b with dissolve_chr
    m "Whether you succeed or fail in your undertakings, you'll still get yourself some new experience!"
    show monika 2k with dissolve_chr
...
label poemresponse_3_monika_appeal_sayori:
    if poemwinner[0] == "sayori":
        ...
        show monika 4a with dissolve_chr
        m "As I said yesterday, [player], there is no 'good' or 'bad.' There is no one right way, remember?"
        show monika 2a with dissolve_chr
        ...
        m "..."
        m "Hmm... Now, that's surprisingly... expected..."
        mc "Was that supposed to make sense?"
        show monika 3l with dissolve_chr
        m "Yeah, I know it sounds very contradictory, but that's the best way I can describe what I'm looking at..."
        mc "What do you mean?"
        show monika 3a with dissolve_chr
        m "Well, you made a sudden change in your style, but one that I could've imagined you making..."
        mc "I'm still lost..."
        show monika 4j with dissolve_chr
        m "Allow me to explain, then."
        m "This style is, first of all, much easier to master, and overall, it's usually a good place to start for a rookie like you."
        show monika 4b with dissolve_chr
        m "But what's more interesting is that you're not the first one here to use it!"
        show monika 4j with dissolve_chr
        m "And that's why I'm not actually surprised by your choice."
    ...
    mc "Well, yeah. What about it?"

    m "I think it's only natural for you two to have this in common."
    m "Her style is largely identical to yours."

    mc "You... might have a point there, but I don't think the same can't be said about ourselves."

    show monika 2d with dissolve_chr
    m "Hmm? And why's that?"

    mc "While we are friends, we're still quite different."
    mc "Sometimes, I ask myself if we would even be friends if we met each other now, for the first time."
...
label poemresponse_3_monika_appeal_natsuki:
    if poemwinner[0] == "natsuki":
        ...
        mc "I think you're exaggerating, Monika. I'm still not sure what I'm doing."
        show monika 1j with dissolve_chr
        ...
        mc "Is it better or worse, Monika? That's what I'd like to know..."
        show monika 3b with dissolve_chr
        m "It's slightly better in terms of quality, but I'm more surprised with your change of style."
        m "You made this poem short and simplistic, but tried to put more emphasis on its meaning."
        show monika 2a with dissolve_chr
    ...
    mc "It's more 'How much time does she let me spend with her?' You of all people should know that."
    show monika 2l with dissolve_chr
    ...
    show monika 2a with dissolve_chr
    m "I thought that would be obvious since you style has started to resemble hers."
    show monika 2j with dissolve_chr
    m "I guess you understood its own unique beauty and decided to try it out for yourself!"

    $ renpy.say(mc, "I... {}think you're exaggerating...".format("still " if poemwinner[0]=="natsuki" else ""))
    show monika 3a with dissolve_chr
    m "Perhaps I am. But honestly, I see nothing wrong with it."
    m "That style is quite uncommon, so sharing poems like this for comparison would be beneficial for everyone."
    ...
    mc "Let's not get ahead of ourselves, okay?"
    show monika 1a with dissolve
    m "No worries. I understand that you're still experimenting, trying to forge your own path."
    mc "Not exactly how I'd have said it, but yeah... I guess you're right, as usual."
    show monika 1t with dissolve_chr
    m "Ahaha! Who's exaggerating now?"
    mc "Huh?"
    m "Come now, [player]. I'm not omniscient or anything. We all make mistakes."
    mc "Yeah, that's true."
    mc "Anyway, do you want to share your poem with me now?"
    show monika 1a with dissolve_chr
...
label poemresponse_3_monika_appeal_yuri:
    if poemwinner[0] == "yuri":
        ...
        mc "I know what you're about to say: It's challenging, it's complex and blah blah blah..."
        show monika 4a with dissolve_chr
        m "But that still doesn't stop you, does it?"
        "I shrug."
        mc "It works, so why should I change?"
        show monika 4j with dissolve_chr
        m "I'm not insisting that you change it, [player]."
        m "I just want you to realize that you should take it more seriously."
        show monika 2a with dissolve_chr
        m "If you think that this is the one, then you need to try your best to meet certain... expectations."
        mc "A task I've been failing at so far, correct?"
        show monika 2m with dissolve_chr
        m "Yeah, to be honest. It is better than your previous one, though."
    else:
        show monika 2d at t11
        m "..."
        m "You've made quite a change, haven't you, [player]?"
        mc "I suppose. As I said, I tried to listen and draw something from your feedback."
        show monika 4d with dissolve_chr
        m "Well, you definitely set yourself quite a challenge."
        m "This style is quite complex, and it requires a lot of skill to master the usage of imagery and metaphors..."
        ...
        m "...okay, second attempt. But it is the first time you're trying out this style..."
        show monika 2m with dissolve_chr
        m "I don't want to discourage you, but I want you to understand that it's going to be difficult path."
...
label poemresponse_3_monika_appeal_monika:
    if poemwinner[0] == "monika":
        ...
        m "...and I also warned you that it might not be the best option to start with..."
        show monika 4k with dissolve_chr
        ...
        m "And after just one day, you can't get too down on yourself about it."
    else:
        show monika 3d at t11
        m "..."
        m "I... didn't expect you to take my feedback so seriously..."
        mc "Just your feedback? I tried to keep in mind what everyone had to say."
        show monika 3l with dissolve_chr
        m "Of course not! I never said you didn't!"
        show monika 3n with dissolve_chr
        m "It's just... you've really surpassed my expectations, [player]."
        m "I definitely would't call it a masterpiece, since it's still quite rough, but I like the new approach you chose..."
        mc "So you think that your feedback had the biggest impact?"
        show monika 3l with dissolve_chr
        m "Well, if I might be so bold... I think so."
        ...
        m "But after looking at your poem... I'm really impressed with how far you wanted to go with just one step..."

    mc "But I didn't go anywhere, right? I don't think that qualifies as a good result."
    mc "Wanting to accomplish something and actually accomplishing it are two completely different things."
    mc "I personally prefer the latter."
    show monika 4b with dissolve_chr
    m "That's the spirit! That is something I can definitely relate to!"
    show monika 2a with dissolve_chr
    ...
    mc "Um... Sure, thanks."
    mc "Though I think you've already done quite enough for me already. You and everyone else, for that matter."
    show monika 1l with dissolve_chr
    m "Y-Yeah, of course! I just meant... if there's anything you want to suggest or... some advice you'd like to get..."
    show monika 1e with dissolve_chr
    m "I'm here for you... all of you..."
    mc "I appreciate that, Monika."
    mc "Anyway, can you show me your poem now?"
    show monika 1m with dissolve_chr
